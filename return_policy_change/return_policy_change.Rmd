...
#setup
rm(list = ls())
setwd("/Users/hayleychou/Downloads/R/Return policy change")
# setwd("Cloud/project")
...
for(i in lp){
  tempdata <- subset(m_olp,product_category==i)
  mpc_ol_sq <- glm.nb(salesquantity~policy_dummy*time_dummy+avg_female+avg_age+avg_income+avg_homeowner+avg_residency+avg_childowner, data = tempdata)
